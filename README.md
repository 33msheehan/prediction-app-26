...
21/44 tickets done · 3 in progress · 20 not started. Legend: ✅ done &nbsp; ◐ in progress &nbsp; ○ not started.
...
| Phase 3 — Forecast CRUD & tree editor | 4/7 | Awaiting review | ✅ T3.1 &nbsp; ✅ T3.2 &nbsp; ◐ T3.3 &nbsp; ◐ T3.4 &nbsp; ✅ T3.5 &nbsp; ◐ T3.6 &nbsp; ✅ T3.7 |
...
*Generated from `BUILD_PLAN.md` + `PROGRESS.md` by `scripts/generate-tracker.mjs` — last updated 2026-06-21. Do not edit this section by hand.*
